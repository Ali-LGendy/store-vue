<template>
    <div class="max-w-4xl mx-auto px-4 py-16">
        <div class="text-center mb-12">
            <h1 class="text-4xl md:text-5xl font-bold text-indigo-700 mb-8">
                About Me
            </h1>
            ...
            <div class="flex flex-col md:flex-row items-center gap-8">
                <div class="flex-shrink-0">
                    <img 
                        src="../../public/Ali.jpeg"
                        alt="Ali El-Gendy" 
                        class="w-32 h-32 rounded-full object-cover shadow-lg border-4 border-indigo-100"
                    />
                </div>
                ...
                <div class="text-center md:text-left space-y-6">
                    ...
                    <p class="text-gray-600 leading-relaxed max-w-2xl">
                        ...
                        I enjoy creating elegant solutions and building user-friendly applications 
                        that make a difference.
                    </p>

                    <div class="flex flex-wrap justify-center md:justify-start gap-4">
                        <a 
                            href="https://www.linkedin.com/in/ali--elgendy/" 
                            target="_blank"
                        ...
                        <a 
                            href="https://github.com/Ali-LGendy" 
                            target="_blank"
                        ...
                        <a 
                            href="https://www.facebook.com/ali.elgendy.3154/" 
                            target="_blank"
                        ...
                        <a 
                            href="https://www.instagram.com/ali_elgondy/" 
                            target="_blank"
